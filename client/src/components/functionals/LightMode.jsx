...
import LightModeButton from '../utils/LightModeButton';
...
export default function LightMode() {
  ...
  return (
    <div className={`flex w-[90%] mx-auto md:w-full justify-center mb-5 md:mb-10 bg-primary items-center h-[50px] rounded-lg`}>
        <div className='flex gap-5 text-secondary-content  items-center'>
            ...
            <LightModeButton toggleSwitch={toggleSwitch} />
