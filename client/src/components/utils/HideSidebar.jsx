...
export default function HideSidebar({setIsHidden, isHidden}) {
  return (
    <div className='flex items-center gap-5 text-[#828FA3] font-bold'>
        ...
        <p onClick={() => setIsHidden(!isHidden)} className='text-[#828FA3] cursor-pointer'>Hide Sidebar</p>
  </div>
  )
}
